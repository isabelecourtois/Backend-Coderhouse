...
cartRouter.post("/:id/productos/:id_prod", validId, existsCart, existsProductForCartPost, postProductInCart);

cartRouter.delete("/:id/productos/:id_prod", validId, existsCart, existsProductInCart, deleteProductInCart);
